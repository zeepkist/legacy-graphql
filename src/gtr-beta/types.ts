export default {
	...
	types: {
		...
		UserFilter: {
			...
			steamId: [29],
			discordId: [29],
			favoritesByIdUser: [30],
			favoritesByIdUserExist: [11],
			personalBestGlobalsByIdUser: [31],
			personalBestGlobalsByIdUserExist: [11],
			userPointsByIdUser: [59],
			userPointsByIdUserExist: [11],
			recordsByIdUser: [61],
			recordsByIdUserExist: [11],
			upvotesByIdUser: [62],
			upvotesByIdUserExist: [11],
			votesByIdUser: [63],
			votesByIdUserExist: [11],
			and: [27],
			or: [27],
			not: [27],
			__typename: [7],
		...
		RecordFilter: {
			...
			splits: [36],
			speeds: [36],
			recordMediasByIdRecord: [37],
			recordMediasByIdRecordExist: [11],
			personalBestGlobalsByIdRecord: [39],
			personalBestGlobalsByIdRecordExist: [11],
			worldRecordGlobalsByIdRecord: [40],
			worldRecordGlobalsByIdRecordExist: [11],
			userByIdUser: [27],
			levelByIdLevel: [42],
			and: [33],
			or: [33],
		...
		LevelFilter: {
			...
			dateCreated: [17],
			dateUpdated: [17],
			favoritesByIdLevel: [43],
			favoritesByIdLevelExist: [11],
			levelItemsByIdLevel: [44],
			levelItemsByIdLevelExist: [11],
			levelMetadataByIdLevel: [46],
			levelMetadataByIdLevelExist: [11],
			levelPointsByIdLevel: [50],
			levelPointsByIdLevelExist: [11],
			personalBestGlobalsByIdLevel: [52],
			personalBestGlobalsByIdLevelExist: [11],
			recordsByIdLevel: [53],
			recordsByIdLevelExist: [11],
			upvotesByIdLevel: [54],
			upvotesByIdLevelExist: [11],
			worldRecordGlobalsByIdLevel: [56],
			worldRecordGlobalsByIdLevelExist: [11],
			votesByIdLevel: [57],
			votesByIdLevelExist: [11],
			and: [42],
			or: [42],
			not: [42],
			__typename: [7],
